...
* *(optional)* writable: Add `--writable` if the group has write permission to the volume.
...
Here is a new way to connect and disconnect groups

List groups of a volume by id

```
$ primehub admin volumes list-groups pv-dataset

id                                    name           displayName                  writable
------------------------------------  -------------  ---------------------------  ----------
0449b887-5c40-44ba-a945-41bc21c8d15a  InfuseAI       InfuseAI                     True
d75ffe02-765b-4963-8ca7-7e2194d21dc7  phusers        auto generated by bootstrap  False
```
* Please note it will return empty list if the volume is at global scope

Add a group connection to a volume by id. By default, it will make the group read-only to the volume.

```
$ primehub admin volumes add-group pv-dataset dc6a0f50-2679-4d6b-b819-8da1b2e1b0f9
```

Add `--writable` flag to make the group writable. This flag only has meanings to `pv`, `nfs`, and `hostPath` types.

```
$ primehub admin volumes add-group pv-dataset dc6a0f50-2679-4d6b-b819-8da1b2e1b0f9 --writable
```

Remove a group connection from a volume by id

```
$ primehub admin volumes remove-group pv-dataset dc6a0f50-2679-4d6b-b819-8da1b2e1b0f9
```